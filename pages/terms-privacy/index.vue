<template>
  <div id="terms-privacy" class="section column is-8 container">
    <div class="columns">
      <div class="column bg-white pd-15rem radius-box">
        <div class="content">
          <p class="title is-3">Terms and Conditions</p>
          <p>
          ...
          <p class="has-text-weight-bold is-size-5">Public Use</p>
          <p>
            All users should commit to ethics and values and should refrain from
            insult and abuse of the site.
          </p>

          <p class="has-text-weight-bold is-size-5">Privacy Policy</p>
          <p>
          ...
          <!-- <p class="has-text-weight-bold is-size-5">Non-Registered Users</p>
          <p>
            ...
            privileges of being a registered member. Non-registered users are,
            however, still subject to the TC and Privacy Policy.
          </p> -->

          <p class="has-text-weight-bold is-size-5">Denial of Access</p>
          <p>
            AskMaker has the right to block any user from accessing the website
            or using it's services in general.
          </p>

          <p class="has-text-weight-bold is-size-5">Impersonation</p>
          <p>
            Impersonation by name or subdomain is not allowed and AskMakers has
            the right to take adequate actions.
          </p>

          <p class="has-text-weight-bold is-size-5">Inactive Accounts</p>
          <p>
          ...
          <p class="has-text-weight-bold is-size-5">Information</p>
          <p>
          ...
          <p class="has-text-weight-bold is-size-5">Limits of Responsibility</p>
          <p>
        ...
        <div class="content">
          <p class="title is-3">Privacy Policy</p>
          <p>
          ...
          <p class="has-text-weight-bold is-size-5">Definitions</p>
          <p>
          ...
          <p class="has-text-weight-bold is-size-6">Timestamps</p>
          <p>
          ...
          <p class="has-text-weight-bold is-size-5">Insights</p>
          <p>
          ...
          <p class="has-text-weight-bold is-size-5">3rd Party Services</p>
          <p class="has-text-weight-bold is-size-6">Email</p>
          <p>
          ...
          <p class="has-text-weight-bold is-size-6">Filtration</p>
          <p>
          ...
          <p class="has-text-weight-bold is-size-6">Analytics Services</p>
          <p>
          ...
          <p class="has-text-weight-bold is-size-6">Notification Tokens</p>
          <p>
          ...
          <p class="has-text-weight-bold is-size-5">Links to External Sites</p>
          <p>
